...
interface FlowcodeStepCollapsibleProps  { node: Node<Properties>; graph: Graph;}
...
export interface FlowcodeStepCollapsibleDataType {
  id: string;
  func: {
    funcpath: string;
    funcname: string;
...
const FlowcodeStepCollapsible: React.FC<FlowcodeStepCollapsibleProps> = (x6props) => {

  const props = x6props.node.getData() as FlowcodeStepCollapsibleDataType;
